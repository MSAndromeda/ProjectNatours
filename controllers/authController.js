...
{
  // Roles is an array and we wrap middleware within a function as we need the array argument
  // and we cannot pass any value in middleware function directly
...
exports.resetPassword = catchAsync( async ( req, res, next ) =>
{
  ...
  // 3) Update changedPasswordAt property for the user: Done using middleware in userModel
